...
import co.neeve.nae2.common.parts.implementations.PartPuller;
...
public class Parts implements Definitions<DamagedItemDefinition> {
	...
	private final DamagedItemDefinition puller;
	...
	public Parts(Registry registry) {
		...
		this.puller = this.createPart(this.itemPart, PartType.PULLER);
	}
	...
	public enum PartType implements IDefinition {
		...
		PULLER("puller", PartPuller.class, Features.PULLER);
